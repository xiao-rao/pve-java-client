...
public class VmConfigResponse {
    ...
    /**
     * Use volume as IDE hard disk or CD-ROM (n is 0 to 3). (Array parameter: use Map with integer keys for ide0, ide1, etc.)
     * Type: object
     * Optional: True
     */
    @JsonProperty("ide")
    ...
    /**
     * Use volume as SATA hard disk or CD-ROM (n is 0 to 5). (Array parameter: use Map with integer keys for sata0, sata1, etc.)
     * Type: object
     * Optional: True
     */
    @JsonProperty("sata")
    ...
    /**
     * Use volume as SCSI hard disk or CD-ROM (n is 0 to 30). (Array parameter: use Map with integer keys for scsi0, scsi1, etc.)
     * Type: object
     * Optional: True
     */
    @JsonProperty("scsi")
    ...
    /**
     * Use volume as VIRTIO hard disk (n is 0 to 15). (Array parameter: use Map with integer keys for virtio0, virtio1, etc.)
     * Type: object
     * Optional: True
     */
    @JsonProperty("virtio")
