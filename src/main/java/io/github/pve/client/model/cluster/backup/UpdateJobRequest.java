...
public class UpdateJobRequest {
     ...
     * Optional: True
     */
    @Size(max=1024, message="Parameter 'notes-template' length must not exceed 1024")
     ...
     * Optional: True
     */
    @Pattern(regexp="\\d{1,2}:\\d{1,2}", message="Parameter 'starttime' does not match pattern")
