...
public class CreateVmRequest {
     ...
     * Optional: True
     */
    @Size(max=255, message="Parameter 'hostname' length must not exceed 255")
     ...
     * Optional: True
     */
    @JsonProperty("ignore-unpack-errors")
    private Boolean ignoreUnpackErrors;
     ...
     * Optional: True
     */
    @Size(max=255, message="Parameter 'ostemplate' length must not exceed 255")
