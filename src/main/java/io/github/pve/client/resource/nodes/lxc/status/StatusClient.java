package io.github.pve.client.resource.nodes.lxc.status;

import java.util.List;
import io.github.pve.client.http.ProxmoxApiExecutor;
import io.github.pve.client.http.PveResponse;
import com.fasterxml.jackson.core.type.TypeReference;
import io.github.pve.client.resource.nodes.lxc.status.current.CurrentClient;
import io.github.pve.client.resource.nodes.lxc.status.start.StartClient;
import io.github.pve.client.resource.nodes.lxc.status.stop.StopClient;
import io.github.pve.client.resource.nodes.lxc.status.shutdown.ShutdownClient;
