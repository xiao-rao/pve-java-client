...
public class UsbClient {
     ...
     */
    public List<MappingUsbIndexResponse> index(String checkNode) {
        Map<String, Object> queryParams = new HashMap<>();
        if (checkNode != null) {
            queryParams.put("check-node", checkNode);
        }
        PveResponse<List<MappingUsbIndexResponse>> response = executor.get(this.basePath, queryParams, new TypeReference<>() {});
