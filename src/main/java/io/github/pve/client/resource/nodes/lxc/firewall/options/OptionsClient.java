package io.github.pve.client.resource.nodes.lxc.firewall.options;

import io.github.pve.client.http.ProxmoxApiExecutor;
import io.github.pve.client.http.PveResponse;
import com.fasterxml.jackson.core.type.TypeReference;
// Import models if needed
import io.github.pve.client.model.nodes.lxc.firewall.options.*;

/**
 * Client for /nodes/{node}/lxc/{vmid}/firewall/options
 * BY '@xiao-rao'
 */
public class OptionsClient {
    ...
    public OptionsClient(ProxmoxApiExecutor executor, String node, String vmId) {
        ...
        this.node = node;
        this.vmId = vmId;
        this.basePath = "/nodes/{node}/lxc/{vmid}/firewall/options".replace("{" + "node" + "}", node).replace("{" + "vmid" + "}", vmId);
    }
