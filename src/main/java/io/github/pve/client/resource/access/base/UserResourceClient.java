...
public class UserResourceClient extends BaseResourceClient {
    ...
    // --- /access/users ---
    public List<User> list() throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public void create(String userId, UserCreationOrUpdateOptions options) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    // --- /access/users/{userid} ---
    public User get(String userId) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public void update(String userId, UserCreationOrUpdateOptions options) throws ProxmoxApiException, ProxmoxAuthException {
        String path = "/access/users/" + userId;
        Map<String, Object> params = ProxmoxApiExecutor.getObjectMapper().convertValue(options, new TypeReference<>() {
        });
    ...
    public void delete(String userId) throws ProxmoxApiException, ProxmoxAuthException {
        String path = "/access/users/" + userId;
    ...
    public List<ApiToken> listTokens(String userId) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public ApiTokenSecret createToken(String userId, String tokenId, ApiTokenCreationOptions options) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public ApiToken getToken(String userId, String tokenId) throws ProxmoxApiException, ProxmoxAuthException {
        String path = "/access/users/" + userId + "/token/" + tokenId;
    ...
    public void updateToken(String userId, String tokenId, ApiTokenCreationOptions options) throws ProxmoxApiException, ProxmoxAuthException {
        String path = "/access/users/" + userId + "/token/" + tokenId;
        Map<String, Object> params = ProxmoxApiExecutor.getObjectMapper().convertValue(options, new TypeReference<>() {
        });
        executor.put(path, null, params, new TypeReference<Void>() {
    ...
    public void deleteToken(String userId, String tokenId) throws ProxmoxApiException, ProxmoxAuthException {
        String path = "/access/users/" + userId + "/token/" + tokenId;
        executor.delete(path, null, null, new TypeReference<Void>() {
        });
    }
    ...
    public TfaStatus getTfa(String userId, Boolean multiple) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public void unlockTfa(String userId) throws ProxmoxApiException, ProxmoxAuthException {
