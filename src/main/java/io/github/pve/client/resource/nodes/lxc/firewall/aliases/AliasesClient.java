package io.github.pve.client.resource.nodes.lxc.firewall.aliases;
...
import io.github.pve.client.model.nodes.lxc.firewall.aliases.*;

/**
 * Client for /nodes/{node}/lxc/{vmid}/firewall/aliases
 * BY '@xiao-rao'
 */
