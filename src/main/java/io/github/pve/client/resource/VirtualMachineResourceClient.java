...
public class VirtualMachineResourceClient extends BaseResourceClient {
    ...
    public String create(String pveNodeName, VMCreationOptions options) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public VirtualMachineConfig getConfig(String pveNodeName, int vmid) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public CurrentVirtualMachineStatus getStatus(String pveNodeName, int vmid) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public String start(String pveNodeName, int vmid) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public String shutdown(String pveNodeName, int vmid, VMLifecycleOptions.ShutdownOptions options) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public String stop(String pveNodeName, int vmid, VMLifecycleOptions.StopOptions options) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public String delete(String pveNodeName, int vmid, VMLifecycleOptions.DeleteOptions options) throws ProxmoxApiException, ProxmoxAuthException {
    ...
    public VncConnectionDetails getVncConsole(String pveNodeName, int vmid) throws ProxmoxApiException, ProxmoxAuthException {
     ...
     * 列出指定虚拟机的所有快照。
     */
    public List<VirtualMachineSnapshot> listSnapshots(String pveNodeName, int vmid) throws ProxmoxApiException, ProxmoxAuthException {
     ...
     */
    public String createSnapshot(String pveNodeName, int vmid, SnapshotCreationOptions options) throws ProxmoxApiException, ProxmoxAuthException {
        String path = String.format("/nodes/%s/qemu/%d/snapshot", pveNodeName, vmid);
        Map<String, Object> bodyParams = ProxmoxApiExecutor.getObjectMapper().convertValue(options, new TypeReference<>() {});
        PveResponse<String> response = executor.post(path, null, bodyParams, new TypeReference<>() {});
     ...
     */
    public String rollbackToSnapshot(String pveNodeName, int vmid, String snapshotName) throws ProxmoxApiException, ProxmoxAuthException {
     ...
     * 删除一个虚拟机的快照。这是一个异步操作。
     */
    public String deleteSnapshot(String pveNodeName, int vmid, String snapshotName) throws ProxmoxApiException, ProxmoxAuthException {
     ...
     * @return 克隆任务的UPID
     */
    public String clone(String pveNodeName, int vmidToClone, CloneOptions options) throws ProxmoxApiException, ProxmoxAuthException {
     ...
     * 创建一个虚拟机模板。这是一个异步操作。
     */
    public String createTemplate(String pveNodeName, int vmid) throws ProxmoxApiException, ProxmoxAuthException {
     ...
     */
    public String migrate(String pveNodeName, int vmid, MigrateOptions options) throws ProxmoxApiException, ProxmoxAuthException {
     ...
     * 调整虚拟机磁盘大小。这是一个异步操作。
     */
    public String resizeDisk(String pveNodeName, int vmid, ResizeDiskOptions options) throws ProxmoxApiException, ProxmoxAuthException {
     ...
     * @return 备份任务的UPID
     */
    public String createBackup(String pveNodeName, BackupOptions options) throws ProxmoxApiException, ProxmoxAuthException {
